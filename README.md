...
+ Возвращает из списка транзакций сумму в рублях, если операция была проведена 
в валюте евро или доллар, то конвертирует в рубли (функция `currency_conversion`)
